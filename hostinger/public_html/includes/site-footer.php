<?php
// Shared site footer: same brand + links as the static pages.
$socials = [
...
<footer class="footer shell">
  <div class="footer-brand">
    <a class="brand" href="/"><img class="brand-cat" src="/bum/favicon-cat.png" alt="Bum Bum the cat"><span>Leave It to<br><b>Bum Bum</b></span></a>
    <p>Useful little tools for busy little businesses.</p>
    <div class="socials"><?php foreach ($socials as $s): ?><a href="<?= htmlspecialchars($s['href']) ?>" target="_blank" rel="noopener" aria-label="<?= $s['label'] ?>"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="<?= $s['path'] ?>"/></svg></a><?php endforeach; ?></div>
  </div>
  ...
  <script src="/petpet.js?v=3" defer></script>
</footer>
