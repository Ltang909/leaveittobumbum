...
?>
<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Checkout | Leave It to Bum Bum</title><link rel="stylesheet" href="/app.css"><script src="https://js.stripe.com/clover/stripe.js"></script></head><body>
<header class="shell"><a class="brand" href="/">BB · Leave It to Bum Bum</a><a href="/account/">Account</a></header>
<main class="shell"><p class="eyebrow">Bum Bum’s checkout</p><h1>Put the busywork on a shorter leash.</h1>
